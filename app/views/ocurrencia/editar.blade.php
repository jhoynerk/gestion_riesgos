							...
							<div class="col-lg-12">
								{{Form::open(['route' => ['admin.ocurrencia.update', $ocurrencia->id], 'method' => 'put', 'role' => 'form'])}}
									...
									<div class="form-group">
										...
										{{ Form::select('riesgo_id',$riesgo,$ocurrencia->riesgo_id,['class' => 'form-control', 'disabled' => 'disabled' ]) }}
									</div>

									<div class="form-group">
										<label for="fecha_error">Fecha de la ocurrecia</label>
										<input type="date" class="form-control" placeholder="Primera Ocurrencia" name="fecha_error" id="fecha_error" value="{{$ocurrencia->fecha_error}}" disabled>
									</div>
									...
									<div class="form-group">
										...
										{{ Form::select('user_responsable_id',$users,$ocurrencia->user_responsable_id,['class' => 'form-control', 'disabled' => 'disabled']) }}
									</div>
									<div class="form-group">
										<label for="costo_impacto">Costo de Impacto del riesgo</label>
										<input type="number" class="form-control" placeholder="Costo del impacto" name="costo_impacto" id="costo_impacto" value="{{$ocurrencia->costo_impacto}}" disabled>
									</div>
									<div class="form-group">
										<label for="costo_solucion">Costo de solución al riesgo</label>
										<input type="number" class="form-control" placeholder="Costo de la solución" name="costo_solucion" id="costo_solucion" value="{{$ocurrencia->costo_solucion}}" disabled>
									</div>
